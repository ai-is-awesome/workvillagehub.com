...
const config = {
  "generator": {
    ...
    "output": {
      "value": "D:\\myStuff\\career\\webdev\\Code\\fullstack\\job-boards\\job-boards\\src\\app\\lib\\prisma\\generated\\prisma-client-js",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/app/lib/prisma/generated/prisma-client-js",
    "app/lib/prisma/generated/prisma-client-js",
  ]
...
path.join(process.cwd(), "src/app/lib/prisma/generated/prisma-client-js/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/app/lib/prisma/generated/prisma-client-js/schema.prisma")
